...
<head>
    ...
    <title>Explore Category : Pack Details</title>
        ...
        <div class="container-xl">
            ...
            <div class="page-header d-print-none">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <h2 class="page-title">
                           Explore Category Pack Name
                        </h2>

                        <div class="page-pretitle">
                            <span class="bg-green-lt"> Packs Details in 'Explore Category'</span>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-auto ms-auto d-print-none">
                        <div class="btn-list">
                            <span class="d-none d-sm-inline"><a
                                        href="{{route('live.coloringbook.dashboard.explore.explore-categories-content-packs')}}"
                                        class="btn btn-primary">Back to 'Explore Category' Packs</a></span>
                        </div>
                    </div>
            ...
            <div class="container-xl">
                ...
                <div class="row row-cards mb-2">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <h3 class="card-title mb-1">Explore Category PACK name maxx allowed character are 32
                                        </h3>

                                        <div class="text-muted">
                                            Explore Category PACK Description Lorem ipsum dolor sit amet, consectetur adipisicing
                                    ...
                                    <div class="mt-3">
                                        <div class="row g-2 align-items-center">
                                            <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                                                <a href="#" class="btn btn-primary w-100" data-bs-target="#add-content-to-pack-modal" data-bs-toggle="modal" title="Add Only Premium Content">
                                                    Add Content to this Pack
                                                </a>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                                                <a href="#" class="btn btn-success w-100" data-bs-toggle="modal" data-bs-target="#edit-explore-pack-details-modal" title="Edit premium Category Details">
                                                    Edit Pack Details
                                                </a>
                                            </div>
                                            <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                                                <a href="#" class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#delete-explore-pack-modal" title="Delete This Premium Category">
                                                    Delete this Pack
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title bg-pink-lt">Pack Details</div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    Pack Price <strong class="bg-green-lt">INR 170</strong>
                                </div>
                                <div class="mb-2">
                                    Total Uploaded Vectors: <strong class="bg-green-lt">10</strong>
                                </div>
                                <div class="mb-2">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card card-sm">
                            ...
                            <div class="card-footer">
                                <div class="mb-2">
                                    <a href="{{route('live.coloringbook.dashboard.explore.explore-categories-content-details')}}" class="btn btn-success w-100">
                                        VIEW CONTENT DETAILS
                                    </a>
                                </div>
                                <div class="mb-2">
                                    <a href="#" class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#delete-content-pack-modal">
                                        DELETE THIS CONTENT
                                    </a>
                                </div>
                            </div>
...
@include('live.coloringbook.modals.explore-categories.pack.delete-content-pack-alert')
@include('live.coloringbook.modals.explore-categories.pack.edit-explore-pack-details')

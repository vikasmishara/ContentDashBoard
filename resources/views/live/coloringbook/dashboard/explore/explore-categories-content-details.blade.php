...
<head>
    ...
    <title>Explore Category : Content Details</title>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row g-2 align-items-center">
                                            <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                                                <a href="#" class="btn btn-danger" data-bs-target="#copy-content-to-pack-modal" data-bs-toggle="modal">
                                                    Copy this Content to other Pack(S)
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-2 align-items-center">
                                            <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                                                <a href="#" class="btn btn-danger" data-bs-target="#move-content-to-pack-modal" data-bs-toggle="modal">
                                                    Move this Content to other Pack
                                                </a>
                                            </div>
                                        </div>
...
@include('live.coloringbook.modals.explore-categories.content.copy-content-to-pack-modal')
@include('live.coloringbook.modals.explore-categories.content.move-content-to-pack-modal')
</body>
</html>e
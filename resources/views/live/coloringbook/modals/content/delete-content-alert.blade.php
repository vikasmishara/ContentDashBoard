    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-muted">Do you really want to delete this content from this 'Category Title' category . This action can not be undone. <b>Once
                        deleted you will loose all the data related to this content.</b>
                </div>
            </div>

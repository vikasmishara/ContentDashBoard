<div class="modal modal-blur fade" id="edit-update-content-details" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Content Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- title  -->
                <div class="mb-3">
                    <label class="form-label">Edit Content Title</label>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <div class="form-label ">Upload New Main SVG / VECTOR File <span class="badge bg-cyan"> Optional</span></div>
                            <input type="file" class="form-control" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <div class="form-label ">Upload New Thumbnail <span class="badge bg-cyan"> Optional</span></div>
                            <input type="file" class="form-control" />
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <label class="form-label">Edit Trade Type</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Edit Design Type</label>
                            <select type="text" class="form-select" placeholder="Select a trade type" id="select-trade-type" value="">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Edit Aspect Ratio</label>
                            <select type="text" class="form-select" placeholder="Select a trade type" id="select-trade-type" value="">
            ...
            <div class="modal-footer">
                <a href="#" class="btn btn-link link-secondary" data-bs-toggle="modal" data-bs-target="#error-alert-content">
                    Cancel this update
                </a>

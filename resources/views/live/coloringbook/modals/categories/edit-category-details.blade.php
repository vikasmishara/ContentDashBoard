<div class="modal modal-blur fade" id="edit-category-details-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- title  -->
                <div class="mb-3">
                    <label class="form-label">Edit Category Title</label>
                ...
                <!-- description  -->
                <div class="mb-3">
                    <label class="form-label">Edit Category Description</label>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <div class="form-label ">Upload New Circular Thumbnail <span class="badge bg-cyan"> Optional</span></div>
                            <input type="file" class="form-control" />
                        </div>
                    </div>
                </div>

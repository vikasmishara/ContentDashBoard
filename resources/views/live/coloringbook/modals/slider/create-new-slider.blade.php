<div class="modal modal-blur fade" id="create-new-slider-modal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <div class="form-label required">Upload Slider Main Thumbnail <span class="badge bg-red"> Required</span></div>
